...
export default function Hamburger(props) {
    ...
    function handleResponse(response) {
        ...
        let apiUrlForecast = `https://api.shecodes.io/weather/v1/forecast?query=${newcity}&key=${apiKey}&units=metric`;
    ...
    return(
            <div className="Hamburger">
                ...
                { (weather.ready) ? <Weather currentweather={weather} forecast={forecast} /> : <p>Loading...</p> }
            </div>
    );
}
